package com.csagent.generator.util;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.convert.Convert;
import cn.hutool.core.lang.Dict;
import com.csagent.common.mybatis.enums.DataBaseType;
import com.csagent.generator.constant.GenConstants;
...
import com.csagent.common.mybatis.helper.DataBaseHelper;
import com.csagent.generator.domain.GenTable;
import com.csagent.generator.domain.GenTableColumn;
...
public class VelocityUtils {
    ...
    public static String getFileName(String template, GenTable genTable) {
        ...
        if (template.contains("mapper.java.vm")) {
            ...
            fileName = StringUtils.format("{}/views/{}/{}/api/index.ts", vuePath, moduleName, businessName);
        } else if (template.contains("model.d.ts.vm")) {
            fileName = StringUtils.format("{}/views/{}/{}/api/model.d.ts", vuePath, moduleName, businessName);
        } else if (template.contains("index.vue.vm")) {
            fileName = StringUtils.format("{}/views/{}/{}/index.vue", vuePath, moduleName, businessName);
        } else if (template.contains("data.ts.vm")) {
            fileName = StringUtils.format("{}/views/{}/{}/data.ts", vuePath, moduleName, businessName);
        } else if (template.contains("modal.vue.vm")) {
            fileName = StringUtils.format("{}/views/{}/{}/{}-modal.vue", vuePath, moduleName, businessName, businessName);
        }
        return fileName;
    }
    ...
    public static HashSet<String> getImportList(GenTable genTable) {
        ...
        for (GenTableColumn column : columns) {
            if (!column.isSuperColumn() && GenConstants.TYPE_DATE.equals(column.getJavaType())) {
                ...
                importList.add("com.csagent.common.translation.annotation.Translation");
                importList.add("com.csagent.common.translation.constant.TransConstant");
            }
        }
        return importList;
    }
