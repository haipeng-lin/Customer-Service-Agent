...
//import com.csagent.application.domain.bo.AppQuestionTestBo;
...
//import com.csagent.common.core.enums.DocumentType;
//import com.csagent.common.core.enums.EmbeddingStatus;
//import com.csagent.common.core.enums.QuestionStatus;
...
//     */
//    @Async
//    public void executeAsyncQuestionTask(MdModel mdModel, List<Long> documentIds, AppQuestionTestBo appQuestion) {
//
...
//
//        // 段落关联的问题，需要重新索引
//        List<KbQuestionParagraph> relationList = kbQuestionParagraphMapper.selectByIds(paragraph.getId());
//
//        // 查出段落问题信息
